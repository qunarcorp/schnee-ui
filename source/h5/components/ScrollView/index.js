...
class ScrollView extends React.Component {
    constructor(props) {
        ...
        if (this.props.bindscrolltoupper) {
            if (typeof this.props.bindscrolltoupper !== 'function') {
                throw new Error('bindscrolltoupper 必须为函数类型');
            }
        ...
        if (this.props.bindscrolltolower) {
            if (typeof this.props.bindscrolltolower !== 'function') {
                throw new Error('bindscrolltolower 必须为函数类型');
            }
    ...
    componentDidMount() {
        ...
        if (scrollIntoView && typeof scrollIntoView !== 'string') {
            throw new Error('scroll-into-view 只能是 string 类型');
        }

        if (typeof scrollWithAnimation !== 'boolean') {
            throw new Error('scroll-with-animation 只能是 true 或者 false');
        }

        if (scrollY) {
            if (typeof scrollY !== 'boolean') {
                throw new Error('scroll-y 只能是 true 或者 false');
            }
            if (scrollTop) {
                if (typeof scrollTop !== 'number' && typeof scrollTop !== 'string') {
                    throw new Error('scroll-top 只能是 number 或者 string 类型');
                }
        ...
        if (scrollX) {
            if (typeof scrollX !== 'boolean') {
                throw new Error('scroll-x 只能是 true 或者 false');
            }
            if (scrollLeft) {
                if (typeof scrollLeft !== 'number' && typeof scrollLeft !== 'string') {
                    throw new Error('scroll-left 只能是 number 或者 string 类型');
                }
    ...
    onScrollListener(event) {
        ...
        if (typeof this.props.bindscroll === 'function') {
            ...
            throw new Error('bindscroll 只能为函数类型');
        }

        if (
            upperThreshold &&
            typeof upperThreshold !== 'number' &&
            typeof upperThreshold !== 'string'
        ) {
            throw new Error('upper-threshold 只能是 number 或者 string 类型');
        }
        if (
            lowerThreshold &&
            typeof lowerThreshold !== 'number' &&
            typeof lowerThreshold !== 'string'
        ) {
            throw new Error('lower-threshold 只能是 number 或者 string 类型');
        }
        ...
        if (scrollY) {
            ...
            if (
                ...
                this.scrollable.scrollTop + this.scrollable.offsetHeight >=
                    this.scrollable.scrollHeight - lowerThreshold
            ) {
            ...
            if (
                lowerThreshold &&
                this.scrollable.scrollLeft + this.scrollable.offsetWidth >=
                    this.scrollable.scrollWidth - lowerThreshold
            ) {
                this.bindscrolltolower(event);
            }
        }
    ...
    scrollTo(position, direction, scrollWithoutAnimation) {
        ...
        if (offset !== 0) {
            if (animation) {
                ...
                this.scrollableInner.removeEventListener(
                    'webkitTransitionEnd',
                ...
                const translateStyle =
                    direction === 'x'
                        ? 'translateX(' + offset + 'px) translateZ(0)'
