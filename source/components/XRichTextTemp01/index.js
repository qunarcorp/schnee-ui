...
import XRichTextTemp02 from '../XRichTextTemp02/index';

class XRichTextTemp01 extends React.Component {
    render() {
        return (
            <block>
                ...
                {this.props.item.name === 'a' && <a class={'octoParse-a ' + this.props.item.attrs.class} style={this.props.item.attrs.style}>
                    {this.props.item.children.map(function(citem){
                        return <XRichTextTemp02 item={citem} />;
                    }, this)}
                </a>}
                ...
                {this.props.item.name === 'h1' && <h1 class={'octoParse-h1 ' + this.props.item.attrs.class} style={this.props.item.attrs.style}>
                    {this.props.item.children.map(function(citem){
                        return <XRichTextTemp02 item={citem} t="h1" />;
                    }, this)}
                </h1>}
                ...
                {this.props.item.name === 'div' && <div class={this.props.item.attrs.class} style={this.props.item.attrs.style}>
                    {this.props.item.children.map(function(citem){
                        return <XRichTextTemp02 item={citem} />;
                    }, this)}
                </div>}
                ...
                {this.props.item.name === 'dt' && <dt class={'octoParse-strong ' + this.props.item.attrs.class} style={this.props.item.attrs.style}>
                    {this.props.item.children.map(function(citem){
                        return <XRichTextTemp02 item={citem} />;
                    }, this)}
                </dt>}
...
export default XRichTextTemp01;
