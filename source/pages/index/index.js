...
class P extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            list: 'button,checkbox,icon,label,navigator,picker,progress,radio,richText,scrollView,slider,swiper,switch,webView,dialog,calendar_selectOne,calendar_selectTwo,calendar'
                .split(',')
                .map(function(name) {
                    return {
